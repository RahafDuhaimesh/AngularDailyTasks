...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-B9MOPR5;Database=AngularTasks;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cart>(entity =>
        {
            entity.HasKey(e => e.CartId).HasName("PK__Carts__51BCD797004C20DE");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__488B0B2A7E570EAB");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.CartItems)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__CartItems__UserI__70DDC3D8");
        });

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B90369392");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6EDF8A918FB");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Service__4550733FD0D57415");
        ...
        {
            entity.HasKey(e => e.SubServiceId).HasName("PK__subServi__C5C51FFA628C9018");
        ...
        {
            entity.HasKey(e => e.SubscriptionId).HasName("PK__subscrip__4A0F55C756A93803");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC0338A453");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D1053419E67D71").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserSubscriptionId).HasName("PK__UserSubs__D1FD777CFB454257");
            ...
            entity.HasOne(d => d.Scription).WithMany(p => p.UserSubscriptions)
                ...
                .HasConstraintName("FK__UserSubsc__Scrip__60A75C0F");

            entity.HasOne(d => d.SubService).WithMany(p => p.UserSubscriptions)
                .HasForeignKey(d => d.SubServiceId)
                .HasConstraintName("FK__UserSubsc__SubSe__5FB337D6");

            entity.HasOne(d => d.User).WithMany(p => p.UserSubscriptions)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__UserSubsc__UserI__5EBF139D");
        });
